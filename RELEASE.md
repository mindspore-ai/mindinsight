...
- Parameter distribution graph (Histogram).
    ...
    Now you can use [`HistogramSummary`](https://www.mindspore.cn/docs/api/en/r1.3/api_python/mindspore.ops.html#mindspore.ops.HistogramSummary) and MindInsight to record and visualize distribution info of tensors. See our [tutorial](https://www.mindspore.cn/mindinsight/docs/en/r1.3/index.html).
