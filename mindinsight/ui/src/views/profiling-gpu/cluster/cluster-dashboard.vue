...
export default {
  ...
  methods: {
    ...
    updatePage() {
      ...
      switch (path) {
        case '/profiling-gpu/cluster/performance':
          this.showDetail = false;
        case '/profiling-gpu/cluster/step-trace':
        case '/profiling-gpu/cluster/communication':
          this.tab = this.tabs[0].name;
          break;
        case '/profiling-gpu/cluster/strategy':
          this.tab = this.tabs[2].name;
          this.showDetail = false;
          break;
        case '/profiling-gpu/cluster/resource':
          this.showDetail = false;
        case '/profiling-gpu/cluster/flops-heatmap':
        case '/profiling-gpu/cluster/memory-heatmap':
    ...
    onTabClick() {
      this.$router.push({
        path: '/profiling-gpu/cluster/' + this.tab,
    ...
    viewDetail(path) {
      this.$router.push({
        path: '/profiling-gpu/cluster/' + path,
        query: this.$route.query,
      });
    },
    /**
