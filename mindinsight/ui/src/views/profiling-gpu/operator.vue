    ...
    <div class="cl-profiler">
      <el-tabs v-model="apiType"
        ...
        <el-tab-pane :label="$t('operator.operatorInfo')"
                     name="op">
          <operator-unit chartId="op-echarts"
                         :currentCard="currentCard"
                         :opType="gpuOpType"
                         :opSortCondition="gpuOpSortCondition"
                         :search="gpuOpSearch"
                         :chart="gpuOpChart"
                         :accuracy="3"
        ...
        <el-tab-pane :label="$t('operator.kernelInfo')"
                     class="cpu-tab"
                     name="cuda">
          <operator-unit chartId="cuda-echarts"
                         :currentCard="currentCard"
                         :opType="gpuCudaType"
                         :opSortCondition="gpuCudaSortCondition"
                         :search="gpuCudaSearch"
                         :chart="gpuCudaChart"
                         :hasBarChart="false"
                         :coreSearchType="gpuCudaSearchType"
