...
For non-transformed operators, the original code keeps. Please manually migrate them. [Click here](https://www.mindspore.cn/docs/note/en/master/index.html#operator_api) for more information about operator mapping.
