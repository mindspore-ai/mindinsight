...
AICORE_DETAIL_COL = ["op_name", "op_type", "avg_execution_time", "execution_frequency", "MFLOPs(10^6 cube)",
                     "GFLOPS(10^9 cube)", "MFLOPs(10^6 vector)", "GFLOPS(10^9 vector)", "full_op_name",]
