...
点击查看[MindInsight设计文档](https://www.mindspore.cn/mindinsight/docs/zh-CN/r1.8/training_visual_design.html)，了解更多设计详情。
点击查看[教程文档](https://www.mindspore.cn/mindinsight/docs/zh-CN/r1.8/index.html)，了解更多MindInsight教程。
...
- 其他依赖参见[requirements.txt](https://gitee.com/mindspore/mindinsight/blob/r1.8/requirements.txt)。
...
> - 在联网状态下，安装whl包时会自动下载MindInsight安装包的依赖项（依赖项详情参见[requirements.txt](https://gitee.com/mindspore/mindinsight/blob/r1.8/requirements.txt)），其余情况需自行安装。
...
[SummaryCollector](https://www.mindspore.cn/docs/zh-CN/r1.8/api_python/mindspore/mindspore.SummaryCollector.html#mindspore.SummaryCollector)是MindSpore提供的快速简易地收集一些常见信息的接口，收集的信息包括计算图、损失值、学习率、参数权重等。
...
更多记录可视化数据的方法，请点击查看[MindInsight使用教程](https://www.mindspore.cn/mindinsight/docs/zh-CN/r1.8/index.html)。
