...
class TMapper(AtenToMindSporeMapper):
    """.T mapper."""
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name = ["input"]
        args_name_list = TMapper.get_args_name_list(**kwargs, args_name=args_name)
    ...
    def _generate_snippet_template(**kwargs):
        ...
        variable_slot = "var_0"
        args_name = ["input"]
        inputs, args, group_inputs = TMapper._params_parser(raw_params=raw_params, args_name=args_name,
        ...
        construct_template = f"opt_{{{variable_slot}}} = {inputs[0]}.{op}(1, 0)"
