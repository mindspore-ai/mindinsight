...
class OnesLikeMapper(AtenToMindSporeMapper):
    """OnesLike mapper."""
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name_list = OnesLikeMapper.get_args_name_list(**kwargs, args_name=args_name_list_mapper)
    ...
    def _generate_snippet_template(**kwargs):
        ...
        inputs, args, group_inputs = OnesLikeMapper._params_parser(raw_params, args_name_list_mapper, trainable_params)
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if OnesLikeMapper.is_tensor(value):
