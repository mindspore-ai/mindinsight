...
class FullLikeMapper(AtenToMindSporeMapper):
    """full_like mapper."""
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name_list_mapper = {
            4: ["input", "value", "unused", "unused"],
            7: ["input", "value", "dtype", "unused", "unused", "unused", "unused"]
        }
        args_name_list = FullLikeMapper.get_args_name_list(**kwargs, args_name=args_name_list_mapper)
    ...
    def _generate_snippet_template(**kwargs):
        ...
        inputs, args, group_inputs = FullLikeMapper._params_parser(raw_params, args_name_list_mapper, trainable_params)
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if FullLikeMapper.is_tensor(value):
