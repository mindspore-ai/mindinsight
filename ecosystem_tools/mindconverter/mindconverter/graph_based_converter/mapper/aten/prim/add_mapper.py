...
class AddMapper(AtenToMindSporeMapper):
    """Add mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input_0", "input_1", "alpha"]
        inputs, args, group_inputs = AddMapper._params_parser(raw_params, args_name_list, trainable_params)
        ...
        if op == "aten::add_":
            ...
            construct_template = f"opt_{{{variable_slot}}} = {inputs[0]} + {inputs[1]}"
