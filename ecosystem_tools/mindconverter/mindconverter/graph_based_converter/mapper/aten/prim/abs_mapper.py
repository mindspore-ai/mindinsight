...
class AbsMapper(AtenToMindSporeMapper):
    """Abs mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        variable_slot = "var_0"
        args_name_list = ["input"]
        inputs, args, group_inputs = AtenToMindSporeMapper._params_parser(raw_params, args_name_list, trainable_params)
        ...
        construct_template = f"opt_{{{variable_slot}}} = ms_np.{op}({inputs[0]})"
