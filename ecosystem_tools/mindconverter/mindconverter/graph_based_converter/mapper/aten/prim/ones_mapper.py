...
class OnesMapper(AtenToMindSporeMapper):
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name_list = OnesMapper.get_args_name_list(**kwargs, args_name=args_name_list_mapper)
    ...
    def _generate_snippet_template(**kwargs):
        ...
        raw_arg_name_list = OnesMapper.get_args_name_list(raw_params=raw_params.copy(),
                                                          args_name=args_name_list_mapper,
                                                          return_raw=True)
        inputs, args, group_inputs = OnesMapper._params_parser(raw_params, args_name_list_mapper, trainable_params)
