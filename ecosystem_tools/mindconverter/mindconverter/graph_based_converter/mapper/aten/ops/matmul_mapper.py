...
class MatMulMapper(AtenToMindSporeMapper):
    """MatMul mapper."""
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name_list = MatMulMapper.get_args_name_list(**kwargs, args_name=args_name)
    ...
    def _generate_snippet_template(**kwargs):
        ...
        variable_slot = "var_0"
        args_name = ["input_0", "input_1"]
        inputs, args, group_inputs = MatMulMapper._params_parser(raw_params=raw_params, args_name=args_name,
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if MatMulMapper.is_tensor(value):
