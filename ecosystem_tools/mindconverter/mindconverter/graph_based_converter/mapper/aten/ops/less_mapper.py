...
class LessMapper(AtenToMindSporeMapper):
    """Less mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input_0", "input_1"]
        inputs, args, group_inputs = LessMapper._params_parser(raw_params, args_name_list, trainable_params)
