...
class GreaterMapper(AtenToMindSporeMapper):
    """Greater mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input_0", "input_1"]
        inputs, args, group_inputs = GreaterMapper._params_parser(raw_params, args_name_list, trainable_params)
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if GreaterMapper.is_tensor(value):
