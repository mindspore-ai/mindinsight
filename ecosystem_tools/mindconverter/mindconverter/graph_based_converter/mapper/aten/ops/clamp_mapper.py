...
class ClipByValueMapper(AtenToMindSporeMapper):
    """ClipByValue mapper."""
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name_list = ["input", "min_val", "max_val"]
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input", "min_val", "max_val"]
        inputs, args, group_inputs = ClipByValueMapper._params_parser(raw_params, args_name_list, trainable_params)
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if ClipByValueMapper.is_tensor(value):
