...
class AddmmMapper(AtenToMindSporeMapper):
    """Addmm mapper."""
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name_list = ["input_0", "input_1", "input_2", "alpha", "beta"]
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input_0", "input_1", "input_2", "alpha", "beta"]
        inputs, args, group_inputs = AddmmMapper._params_parser(raw_params, args_name_list, trainable_params)
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if AddmmMapper.is_tensor(value):
        ...
        construct_template = f"opt_{{{variable_slot}}} = " \
                             f"P.matmul({inputs[1]}, {inputs[2]}) * {inputs[3]} + {inputs[0]} * {inputs[4]}"
