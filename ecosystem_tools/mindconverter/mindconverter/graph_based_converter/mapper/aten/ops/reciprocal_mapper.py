...
class ReciprocalMapper(AtenToMindSporeMapper):
    """Reciprocal mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        op = raw_params.get("operation")
        variable_slot = "var_0"
        trainable_params = kwargs.get("trainable_params")
        args_name_list = ["input"]
        inputs, args, group_inputs = ReciprocalMapper._params_parser(raw_params, args_name_list, trainable_params)
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if ReciprocalMapper.is_tensor(value):
