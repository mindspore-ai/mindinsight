...
class RsqrtMapper(AtenToMindSporeMapper):
    """Rsqrt mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input"]
        inputs, args, group_inputs = RsqrtMapper._params_parser(raw_params, args_name_list, trainable_params)
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if RsqrtMapper.is_tensor(value):
