...
# ==============================================================================
"""Mapper from aten to mindspore for ops."""
...
class NotEqualMapper(AtenToMindSporeMapper):
    """NotEqual mapper."""
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name_list = NotEqualMapper.get_args_name_list(**kwargs, args_name=args_name)
    ...
    def _generate_snippet_template(**kwargs):
        ...
        variable_slot = "var_0"
        args_name = ["input_0", "input_1"]
        inputs, args, group_inputs = NotEqualMapper._params_parser(raw_params=raw_params, args_name=args_name,
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if NotEqualMapper.is_tensor(value):
