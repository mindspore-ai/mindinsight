...
class NegMapper(AtenToMindSporeMapper):
    """neg mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input"]
        inputs, args, group_inputs = NegMapper._params_parser(raw_params, args_name_list, trainable_params)
