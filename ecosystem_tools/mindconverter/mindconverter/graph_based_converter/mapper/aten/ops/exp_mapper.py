...
class ExpMapper(AtenToMindSporeMapper):
    """Exp mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input"]
        inputs, args, group_inputs = ExpMapper._params_parser(raw_params, args_name_list, trainable_params)
        init_template_list = list()
        parameters_declared = dict()
        for name, _ in trainable_params.copy().keys():
