...
class PowMapper(AtenToMindSporeMapper):
    """Pow mapper."""
    ...
    def _generate_snippet_template(**kwargs):
        ...
        args_name_list = ["input", "index"]
        inputs, args, group_inputs = PowMapper._params_parser(raw_params, args_name_list, trainable_params)
