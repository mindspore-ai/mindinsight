...
class ConcatMapper(AtenToMindSporeMapper):
    """Concat mapper."""
    ...
    def _convert_trained_weights(**kwargs):
        ...
        args_name = ["input", "dim"]
        args_name_list = ConcatMapper.get_args_name_list(**kwargs, args_name=args_name)
    ...
    def _generate_snippet_template(**kwargs):
        ...
        variable_slot = "var_0"
        args_name = ["input", "dim"]
        inputs, args, group_inputs = ConcatMapper._params_parser(raw_params=raw_params,
                                                                 args_name=args_name,
                                                                 trainable_params=trainable_params)
        args = ConcatMapper._get_args(args=args)
        ...
        for name, trainable_param in trainable_params.copy().items():
            ...
            if ConcatMapper.is_tensor(value):
